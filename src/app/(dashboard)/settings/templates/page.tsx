...
import { TrendingUp, LayoutDashboard, Receipt, Tags, X, Check } from 'lucide-react'
import {
  Dialog,
  DialogContent,
  DialogTitle,
  ...
  return (
    <div className="max-w-4xl space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div className={`h-32 bg-gradient-to-br ${salesTemplate.color} flex items-center justify-center`}>
            <salesTemplate.icon className="h-12 w-12 text-white/90" />
          </div>
          <div className="p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <Badge variant="secondary" className="text-xs">사용 중</Badge>
            </div>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="w-[95vw] md:w-[70vw] sm:max-w-none h-[85vh] md:h-[70vh] p-0 gap-0 overflow-hidden [&>button]:hidden">
          ...
          <div className="flex flex-col md:flex-row h-full overflow-hidden">
            <div className={`h-32 md:h-auto md:w-2/5 bg-gradient-to-br ${salesTemplate.color} flex items-center justify-center relative shrink-0`}>
              <salesTemplate.icon className="h-16 w-16 md:h-24 md:w-24 text-white/90" />
              <button
